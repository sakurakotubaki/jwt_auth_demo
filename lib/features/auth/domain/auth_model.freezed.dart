...
abstract class $UserCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String username, String email, List<Book> books});
}
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, username: $username, email: $email, books: $books)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      final List<Book> books}) = _$UserImpl;
...
class _$BookImpl implements _Book {
  ...
  @override
  String toString() {
    return 'Book(id: $id, title: $title, description: $description, ownerId: $ownerId)';
  }
...
abstract class _Book implements Book {
  const factory _Book(
      ...
      @JsonKey(name: 'owner_id') required final int ownerId}) = _$BookImpl;
